...
#if (defined(OPENBSDV) && OPENBSDV >= 3030) || (defined(NETBSDV) && __NetBSD_Version__ >= 106060000)
...
#include <sys/buf.h>
    ...
    (defined(NETBSDV) && __NetBSD_Version__ >= 106060000 && __NetBSD_Version__ < 399001100)
#undef _KERNEL
#endif /* (defined(OPENBSDV) && OPENBSDV>=3030) \
	   || (defined(NETBSDV) && __NetBSD_Version__>=106060000 \
...
#endif /* defined(nbpg) */
#define nbpg \
    4096 /* WARNING!!!  This should be 8192 for sun4,
