    ...
    case AF_INET6:
        ...
        if (p.pr_protocol == IPPROTO_TCP) {
            ...
            /*
                 ...
                 */
            if (inp.inp_ppcb && !kread((KA_T)inp.inp_ppcb, (char *)&t, sizeof(t))) {
                ts = 1;
                tsn = (int)t.t_state;
                tsnx = tsn + TcpStateOffset;
            }
        }
        if (ts && (TcpStateIncludeCount || TcpStateExcludeCount) && (tsnx >= 0) &&
            (tsnx < TcpNumStates)) {
        ...
        /*
             ...
             */
        enter_dev_ch(print_kptr((KA_T)(inp.inp_ppcb ? inp.inp_ppcb : s.so_pcb), (char *)NULL, 0));
        ...
        if (fam == AF_INET && (inp.inp_faddr.s_addr != INADDR_ANY || inp.inp_fport != 0)) {
        ...
        if (ts) {
            ...
            CurrentLocalFile->lts.state.val = tsn;
    ...
    case AF_UNIX:
        ...
        if (unp.unp_addr) {
            ...
            if ((uo + sizeof(struct sockaddr)) <= sizeof(mb))
                ...
                if (mb.m_hdr.mh_data && !kread((KA_T)mb.m_hdr.mh_data, (char *)&un, sizeof(un))) {
                    ua = &un;
                }
            }
#else  /* AIXV<3200 */
