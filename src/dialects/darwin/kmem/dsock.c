 ...
 */
    ...
    case AF_INET6:
         ...
         */
            if (!s.so_pcb || kread((KA_T)s.so_pcb, (char *)&in6p, sizeof(in6p))) {
         ...
         */
            enter_dev_ch(
                print_kptr((KA_T)(in6p.in6p_ppcb ? in6p.in6p_ppcb : s.so_pcb), (char *)NULL, 0));
...
#if defined(HASIPv6)
        if ((fam == AF_INET6) && ((la && IN6_IS_ADDR_V4MAPPED((struct in6_addr *)la)) ||
    ...
    case AF_NDRV: {
        ...
        /*
             ...
             */
        if (!s.so_pcb || kread((KA_T)s.so_pcb, (char *)&ndrv_cb, sizeof(ndrv_cb))) {
        ...
        /*
             ...
             */
        if (!ndrv_cb.nd_if || kread((KA_T)ndrv_cb.nd_if, (char *)&ifnet, sizeof(ifnet))) {
            (void)snpf(NameChars, NameCharsLength, "can't read ifnet at %s",
                       print_kptr((KA_T)ndrv_cb.nd_if, (char *)NULL, 0));
            enter_nm(NameChars);
            return;
        }
        if (!ifnet.if_name || kread((KA_T)ifnet.if_name, buf, sizeof(buf))) {
    ...
    case AF_SYSTEM:
        ...
        /*
             * Read protocol control block.
             */
        if (!s.so_pcb || kread((KA_T)s.so_pcb, (char *)&kev_cb, sizeof(kev_cb))) {
        ...
        /*
             ...
             */
        enter_dev_ch(print_kptr((KA_T)(s.so_pcb), (char *)NULL, 0));
        (void)snpf(NameChars, NameCharsLength, "[%lx:%lx:%lx]", kev_cb.vendor_code_filter,
 ...
 */
    case AF_UNIX:
        ...
        if (!s.so_pcb || kread((KA_T)s.so_pcb, (char *)&unp, sizeof(unp))) {
